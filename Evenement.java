...
public class Evenement {
    ...
    public int getIdEvenement(){return this.idEvenement;}
    public void setIdEvenement(int idEvenement){this.idEvenement = idEvenement;}

    public String getnom(){return this.nom;}
    public void setnom(String nom){this.nom = nom;}

    public int getnombreInvite(){return this.nombreInvite;}
    public void setnombreInvite(int nombreInvite){this.nombreInvite = nombreInvite;}
